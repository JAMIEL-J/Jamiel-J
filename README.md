...
```mermaid
flowchart LR
    A[Natural Language] --> B[LLM Reasoning]
    B --> C[SQL Generation]
    C --> D[SQLGlot Validation]
    D --> E[DuckDB Engine]
    E --> F[Visualization & Insights]
```
...
<details>
<summary><b>🔍 Detailed Breakdown of Analytics Projects</b> <i>(Click to expand)</i></summary>
<br/>
